...
export const DICT: Record<string, { th: string; en: string }> = {
  ...
  runs_job_title: { th: "ศูนย์ควบคุมงานรัน", en: "Job Center" },
  ...
  hist_due_note: { th: "บันทึกผลจริงผ่าน scripts/resolve_predictions.py", en: "Log real outcomes via scripts/resolve_predictions.py" },
  ...
  rd_prediction_note: {
    th: "run นี้ลงทะเบียนคำทำนาย 1 รายการแบบแก้ไม่ได้ — ครบกำหนดแล้วบันทึกผลจริงผ่าน scripts/resolve_predictions.py",
    en: "This run registered one immutable prediction — log the real outcome via scripts/resolve_predictions.py when due",
  },
  ...
  pk_title_new: { th: "สร้าง persona pack ใหม่", en: "New persona pack" },
  pk_title_edit: { th: "แก้ไข persona pack", en: "Edit persona pack" },
  pk_desc: {
    th: "ปรับกลุ่มประชากรจำลองได้ทุกมิติ: จำนวนกลุ่ม สัดส่วน นิสัยวัฒนธรรม และสื่อที่แต่ละกลุ่มเสพ — แก้ด้วยมือหรือให้ AI ช่วยร่างก็ได้",
    en: "Shape the simulated population: group count, shares, cultural priors, and each group's media diet — edit by hand or let AI draft.",
  },
  pk_gov_note: {
  ...
  pk_save: { th: "บันทึก pack ใหม่", en: "Save new pack" },
  ...
  pk_census_readonly: {
    th: "ค่าเริ่มต้นจากสำมะโน — อ่านอย่างเดียว กด 📋 เพื่อทำสำเนาไปแก้",
    en: "Census default — read-only; press 📋 to duplicate and edit",
  },
  ...
  pk_new_blank: { th: "สร้าง pack เอง", en: "New pack" },
  pk_new_ai: { th: "ให้ AI ร่าง pack", en: "AI draft a pack" },
  pk_loading_census: { th: "กำลังโหลดสำเนาสำมะโน...", en: "Loading census copy..." },
  pk_delete_title: { th: "ลบ persona pack นี้?", en: "Delete this persona pack?" },
  pk_delete_confirm: {
    th: "ลบแล้วกู้คืนไม่ได้ — รันเก่าที่เคยใช้ pack นี้ไม่ได้รับผลกระทบ",
    en: "This cannot be undone — past runs that used it are unaffected",
  },
  pk_delete_ok: { th: "ลบ pack", en: "Delete pack" },
  pk_no_draft: {
    th: "ยังไม่มีร่างที่กำลังแก้ — ปิดหน้าต่างนี้แล้วเลือกแก้ไข pack หรือทำสำเนาสำมะโนจากหน้าหลัก",
    en: "No draft open — close this window and pick a pack to edit from the main page",
  },
  pk_share_total: { th: "สัดส่วนรวมทุกกลุ่ม", en: "Total share" },
  pk_normalize: { th: "ปรับให้รวม 100%", en: "Normalize to 100%" },
  pk_overwrite_title: { th: "ทับร่างที่แก้ค้างอยู่?", en: "Overwrite the current draft?" },
  pk_overwrite_confirm: {
    th: "ผลที่ AI ร่างใหม่จะแทนที่ร่างที่คุณแก้ค้างอยู่ในแท็บแก้ไข",
    en: "The new AI draft will replace the draft you are editing",
  },
  ...
  pk_untitled: { th: "pack ไม่มีชื่อ", en: "Untitled pack" },
  ...
  pk_media_diet_note: {
    th: "กำหนดทั้งการแพร่ข่าวสารในโลกจำลอง และข่าวที่กลุ่มนี้เห็นจากโต๊ะข่าวสด",
    en: "Drives both how narratives spread in the simulated world, and which live-news items this group sees",
  },
  ...
  pk_ch_offline_wom: { th: "ปากต่อปาก (offline)", en: "Word of mouth (offline)" },
