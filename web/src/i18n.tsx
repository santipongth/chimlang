...
const DICT: Record<string, { th: string; en: string }> = {
  ...
  pk_title: { th: "จัดการกลุ่มประชากรจำลอง (Persona Packs)", en: "Manage persona packs" },
  pk_desc: {
    th: "เลือกชุดกลุ่มที่จะใช้ในรัน หรือปรับแต่งเอง: จำนวนกลุ่ม สัดส่วน นิสัยวัฒนธรรม และสื่อที่แต่ละกลุ่มเสพ — จะแก้ด้วยมือหรือให้ AI ช่วยร่างก็ได้",
    en: "Pick the population for this run, or customize it yourself: group count, shares, cultural priors, and each group's media diet — edit by hand or let AI draft.",
  },
  pk_gov_note: {
  ...
  // Persona Pack Editor (P8 — แก้กลุ่ม/media diet เองได้)
  wiz_persona_manage: { th: "จัดการ persona packs", en: "Manage persona packs" },
  pk_tab_pick: { th: "เลือกชุดกลุ่ม", en: "Pick" },
  pk_tab_edit: { th: "แก้ไข", en: "Edit" },
  pk_tab_ai: { th: "ให้ AI ร่าง", en: "AI draft" },
  pk_census_readonly: {
    th: "ค่าเริ่มต้นจากสำมะโน — อ่านอย่างเดียว ทำสำเนาไปแก้ได้",
    en: "Census default — read-only; duplicate to edit",
  },
  ...
  pk_use_in_run: { th: "ใช้ในรันนี้", en: "Use in this run" },
  pk_edit_btn: { th: "แก้ไข", en: "Edit" },
  pk_delete_confirm: {
    th: "ลบ pack นี้? รันเก่าที่เคยใช้ pack นี้ไม่ได้รับผลกระทบ",
    en: "Delete this pack? Past runs that used it are unaffected",
  },
  pk_no_packs_hint: {
    th: "ยังไม่มี pack ของคุณเอง — ทำสำเนาสำมะโนไปแก้ หรือให้ AI ร่างจากคำบรรยาย",
    en: "No custom packs yet — duplicate the census, or let AI draft one from a description",
  },
  pk_no_draft: {
    th: "ยังไม่มีร่างที่กำลังแก้ — เลือก 'ทำสำเนาเพื่อแก้ไข' หรือ 'แก้ไข' pack จากแท็บเลือกชุดกลุ่ม",
    en: "No draft open — use 'Duplicate to edit' or 'Edit' a pack from the Pick tab",
  },
  pk_editing_existing: { th: "กำลังแก้ pack", en: "editing pack" },
  pk_share_total: { th: "สัดส่วนรวมทุกกลุ่ม", en: "Total share" },
  pk_normalize: { th: "ปรับให้รวม 100%", en: "Normalize to 100%" },
  pk_normalized_notice: {
    th: "บันทึกแล้ว — ระบบปรับสัดส่วนให้รวมเป็น 100% อัตโนมัติ",
    en: "Saved — shares were auto-normalized to total 100%",
  },
  pk_saved: { th: "บันทึกแล้ว", en: "Saved" },
  pk_overwrite_confirm: {
    th: "มีร่างที่ยังไม่บันทึกอยู่ — ทับร่างเดิม?",
    en: "You have an unsaved draft — overwrite it?",
  },
