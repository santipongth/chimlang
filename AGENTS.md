...
4. brief ของเฟสปัจจุบัน (ดู "Scope ปัจจุบัน" ใน `CLAUDE.md` — ล่าสุด: `docs/PHASE9-BRIEF.md`) — backlog + checklist
...
- Scope = เฟสปัจจุบันตาม `CLAUDE.md` เท่านั้น (ล่าสุด: Phase 9 ตามมติผู้ใช้ 17 ก.ค. 2026) — ห้ามเริ่มงานนอก scope โดยไม่ถาม
