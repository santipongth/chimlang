...
- Scope ปัจจุบัน: **Phase 4 (Production Readiness)** — ดู @docs/PHASE4-BRIEF.md (Phase 0-3 ของ PRD ปิดครบแล้ว: ดู brief แต่ละเฟสใน docs/) ห้ามเริ่มงานนอก scope โดยไม่ถามก่อน
